package com.sikesalnew.audio.Library;
...
public class RecordDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String strTitle = _strTitle == null ? "Disposisi Suara" : _strTitle;
...
//        File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath(), timeStamp + ".wav");
         file = new File("/storage/emulated/0/eoffice","Audio-"+timeStamp + ".wav");
